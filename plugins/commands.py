    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                   InlineKeyboardButton("🗣️𝙶𝚛𝚘𝚞𝚙", url="https://t.me/sasi7654/2"),
                   InlineKeyboardButton("🤖Bot List", url="https://t.me/sasi7654/2"),
                   InlineKeyboardButton("👨‍💻Source", url="https://t.me/sasi7654/2")
                ],
                [
                   InlineKeyboardButton("🔻 Subscribe Now YouTube 🔻", url="https://t.me/sasi7654/2")
                ]
            ]
        ),
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("🖥️ 𝙷𝚘𝚠 𝚝𝚘 𝙳𝚎𝚙𝚕𝚘𝚢 🖥️", url="https://t.me/sasi7654/2")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
            ...
            [
                [
                    InlineKeyboardButton(
                        "⛓️ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 ⛓️", url="https://t.me/sasi7654/2")
                ],
                [
